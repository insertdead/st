 ...
 */
static char *font = "Iosevka Nerd Font Mono:pixelsize=15:antialias=true:autohint=true";
 ...
 * 4: value of shell in /etc/passwd 5: value of shell in config.h */ static char *shell = "/bin/sh"; char *utmp = NULL;
